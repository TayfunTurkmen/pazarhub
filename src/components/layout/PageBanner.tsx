...
export default function PageBanner({ icon: Icon, title, subtitle, badge }: PageBannerProps) {
  return (
    <section className="relative -mx-4 sm:-mx-6 lg:-mx-8 xl:-mx-16 2xl:-mx-24 -mt-8 mb-6 overflow-hidden">
      <div className="bg-gradient-to-r from-[var(--color-navy)] via-[#122036] to-[#1a3358] px-4 sm:px-6 lg:px-8 xl:px-16 2xl:px-24 py-8">
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          {Icon && (
            <div className="w-12 h-12 rounded-xl bg-[var(--color-brand-accent)] flex items-center justify-center shrink-0 shadow-md">
