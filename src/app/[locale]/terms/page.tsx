...
export default async function TermsPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-8 text-[var(--color-foreground)]">{t('terms_title')}</h1>
            <Card className="p-8 prose dark:prose-invert max-w-none">
                <h2>1. Genel Hükümler</h2>
                <p>Bu web sitesini kullanarak aşağıdaki kullanım koşullarını kabul etmiş olursunuz. SahibindenKonutAl.com, Türkiye merkezli bir ilan platformu olup, kullanıcılara emlak, vasıta ve ikinci el ürün alım-satım hizmeti sunmaktadır.</p>
                ...
                <p>SahibindenKonutAl, kullanıcılar arasında gerçekleşen işlemlerden doğrudan sorumlu değildir. Platform sadece aracılık hizmeti sunmakta olup, alıcı ve satıcı arasındaki anlaşmazlıklarda taraf değildir.</p>

                <h2>6. Fikri Mülkiyet</h2>
                <p>Site içeriği, tasarım, logo ve yazılımlar SahibindenKonutAl'a aittir. İzinsiz kopyalama, çoğaltma veya dağıtma yasaktır.</p>
