  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <Card className="p-8 prose dark:prose-invert max-w-none">
        ...
        <p>Bu web sitesini kullanarak aşağıdaki kullanım koşullarını kabul etmiş olursunuz. skonutal.com, Türkiye merkezli bir emlak platformu olup, kullanıcılara satılık ve kiralık konut, iş yeri, arsa ve proje hizmeti sunmaktadır.</p>
        <h2>2. Üyelik</h2>
        ...
        <p>skonutal.com, kullanıcılar arasında gerçekleşen işlemlerden doğrudan sorumlu değildir. Platform sadece aracılık hizmeti sunmakta olup, alıcı ve satıcı arasındaki anlaşmazlıklarda taraf değildir.</p>
        <h2>6. Fikri Mülkiyet</h2>
        <p>Site içeriği, tasarım, logo ve yazılımlar skonutal.com&apos;a aittir. İzinsiz kopyalama, çoğaltma veya dağıtma yasaktır.</p>
